    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postal_code', models.CharField(default='32-856', max_length=6, verbose_name='Postal Code')),
                ('role', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'Moderator'), (2, 'Vendor'), (3, 'User')], null=True)),
