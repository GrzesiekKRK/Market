...
from .views import CreateOrderTemplateView, OrderListTemplateView, OrderDetailTemplateView, OrderDeleteUnpaidView
...
urlpatterns = [
    ...
    path('delete/<int:pk>/', OrderDeleteUnpaidView.as_view(), name='customer-delete-unpaid-order'),
